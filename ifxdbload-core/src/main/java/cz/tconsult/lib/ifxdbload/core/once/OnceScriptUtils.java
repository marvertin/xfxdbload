...
import cz.tconsult.spl.parser.SplSqlAlterTableClause;
import cz.tconsult.spl.parser.SplSqlCommandCreate;
...
public class OnceScriptUtils {
  ...
  public boolean testEnd(boolean aIsTransactionClosed,SplBase0 aCommand,List<OnceError> aErrors){
    ...
    if(aCommand instanceof cz.tconsult.spl.parser.SplSqlCommandRollbackWork){
  ...
  public boolean testStart(boolean aIsTransactionOpened,SplBase0 aCommand,List<OnceError> aErrors){
    ...
    if(aCommand instanceof cz.tconsult.spl.parser.SplSqlCommandBeginWork){
  ...
  public static Class<? extends SplBase0> commandToClass(ECommand aECommand){
    switch(aECommand){
      case INDEX:return cz.tconsult.spl.parser.SplSqlCommandCreateIndex.class;
    }
    return null;
  }
}
