...
import cz.tconsult.lib.ifxdbload.core.once.datatypes.OnceScriptInfo;
import cz.tconsult.lib.ifxdbload.core.once.datatypes.SqlCommand;
import cz.tconsult.lib.ifxdbload.core.once.enums.ECommand;
import cz.tconsult.lib.ifxdbload.core.once.enums.EErrorType;
...
import cz.tconsult.parser.util.SyntaxErrorException;
...
public class OnceScript  {
      ...
      throws IOException,SyntaxErrorException
  {
    ...
    for(final SplBase0 child : children){
      ...
      if(child instanceof cz.tconsult.spl.parser.SplSqlCommandBeginWork){
      ...
      if(child instanceof cz.tconsult.spl.parser.SplSqlCommandRollbackWork ||
          child instanceof cz.tconsult.spl.parser.SplSqlCommandCommitWork){
        if(!iScriptInfo.isNoTransFind()){
          if(child instanceof cz.tconsult.spl.parser.SplSqlCommandCommitWork){
