 ...
 *
 */
public class TrgXmlLoader extends DbObjLoader0 {


  private static final Logger log = LoggerFactory.getLogger(TrgXmlLoader.class);

  private final CatalogHasher catalogHasher;


  public TrgXmlLoader(final LoadContext ctx) {
    super(ctx);
