...
public interface CounterMap<T>
{
  ...
  /**
   * Inkrementuje o jedničku čítače specifikované zadanou kolekcí
   * @param coll
   */
  public void inc(Collection<T> coll);
  ...
  /**
   * Dekrementuje o jedničku čítače specifikované zadanou kolekcí
   * @param aKey Objekt, který má být počítán.
   * @return Hodnota čítače před provedením operace.
   */
  public void dec(Collection<T> coll);
  ...
  /**
   * Přičte dle kolekce zadanou hodnotu.
   * @param aKey Objekt, který má být čítán.
   * @param aOKolik O jkolik má být čítač změněn. Může být kladné, záporné nebo 0.
   * @return Hodnota čítače před provedením operace.
   */
  public void add(Collection<T> aKey, int aOKolik);
   ...
   * @return Naplněný objekt implementující rozhraní Map jako mapa na čítače. Mapa obsahuje
   * pouze čítače, které mají aktuálně nenulovou hodnotu a to bez ohledu na to,
   * zda dřívě nějakou hodnotu měly.
   */
  ...
  /**
   * Vrátí počet čítačů, které mají nenulovou hodnotu.
   * @return
   */
